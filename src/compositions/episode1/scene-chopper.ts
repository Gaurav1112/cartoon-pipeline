 ...
 *
 * SOLUTION: Auto-split scenes >75 frames (2.5s @ 30fps) into 2-3 sub-shots
 ...
 * - Backwards compatible: scenes ≤75 frames return 1 sub-shot (no chop)
...
export function chopScene(
  ...
  // LONG SCENE: split into chunks of ~70 frames each (slightly smaller for more cuts)
  const chunkSize = 70;
